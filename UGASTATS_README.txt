Techzilla: Logan Scheid, Ja'Von Holmes, Isaiah McCoy
====================================================
UGASTATS SETUP:
...
Step 2: Setting up the uga-stats spring boot application
    ...
    IMPORTANT:
    -Before running the app, please navigate to the uga-stats/src/main/resources and open the application.properties file
    -Change the username and password properties to yours for your MySQL server.
